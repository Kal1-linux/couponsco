...
const SearchBar = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`http://3.138.92.54:3000/api/getAllStore`);
                const categories = await axios.get(`http://3.138.92.54:3000/api/getCategories`);
                const events = await axios.get(`http://3.138.92.54:3000/api/getAllEvents`);

...
const UpdateCoupons = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            let config = {
                method: 'put',
                maxBodyLength: Infinity,
                url: `http://3.138.92.54:3000/api/admin/${cId}`,
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`http://3.138.92.54:3000/api/coupons/${sId}/${cId}`);
                const storeData = await axios.get(`http://3.138.92.54:3000/api/getStore/${sId}`);
                const eventName = await axios.get(`http://3.138.92.54:3000/api/eventcoupon/${cId}`);
    ...
    const handleAdd = async () => {
        ...
        try {
            ...
            await axios.post(
                `http://3.138.92.54:3000/api/admin/addToOffer/${sId}`,
                formdata,
                {
                    headers: {

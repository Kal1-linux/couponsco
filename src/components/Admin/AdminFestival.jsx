...
function AdminFestival() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://3.138.92.54:3000/api/festStoreDisplay');
    ...
    const handleDelete = async () => {
        ...
        try {
            const res = await axios.delete(`http://3.138.92.54:3000/api/deleteOffer`, {
                headers: {
    ...
    const handleSubmit = async (values) => {
        try {
            ...
            const apiUrl = isUpdate
                ? 'http://3.138.92.54:3000/api/updateDetails'
                : 'http://3.138.92.54:3000/api/admin/addFest&Disc';

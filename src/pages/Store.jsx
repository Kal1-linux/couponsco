...
const Store = () => {
    ...
    const handleRegister = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post(`http://3.138.92.54:3000/api/register`, {
                name: name1,
                email,
                password,
            });
    ...
    const handleLogin = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.post(`http://3.138.92.54:3000/api/login`, {
                email,
                password,
            });
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const res = await axios.get(`http://3.138.92.54:3000/api/getStore/${sId}`);
                const coup = await axios.get(`http://3.138.92.54:3000/api/coupons/${sId}`);
                ...
                const response = await axios.get(`http://3.138.92.54:3000/api/clouser`);
                ...
                const getStoreInfo = async stores => {
                    return await Promise.all(
                        stores.map(async store => {
                            const res = await axios.get(`http://3.138.92.54:3000/api/getStore/${store.sId}`);
        ...
        const fetchData = async () => {
            ...
            if (userId) {
                try {
                    ...
                    const response = await axios.get(`http://3.138.92.54:3000/api/getDetails/${userId}`, config);
    ...
    const handleUse = async (cId) => {
        try {
            await axios.patch(`http://3.138.92.54:3000/api/inCount/${cId}`);
        } catch (error) {
            console.error(error);
        }
    }
    ...
    const handleReview = async (rate) => {
        ...
        try {
            await axios.put(`http://3.138.92.54:3000/api/addRatings/${sId}`, data, {
                headers: {
    ...
    const handleLikeClick = async (index, cId) => {
        ...
        try {
            ...
            if (!likedItems.includes(cId)) {
                ...
                await axios.post(`http://3.138.92.54:3000/api/saveCoupon/${cId}`, { userId }, config);
            } else {
                ...
                await axios.delete(`http://3.138.92.54:3000/api/unsaveCoupon/${cId}`, config);
            }
        } catch (error) {
                    ...
                    <div className="bg-white p-10 rounded-xl border flex flex-col gap-5 my-10">
                        ...
                        <form className="w-56 max-w-screen-lg lg:w-96 mx-auto">
                            ...
                            <Typography color="gray" className="mt-2 mx-auto font-normal">
                                <Link to="http://3.138.92.54:3000/api/forgot-password" className=" underline font-medium transition-colors hover:text-orange-700 cursor-pointer">
